...
EXX=em++
WASM_OPTIMIZATION_LEVEL=-Oz
EXXFLAGS=-std=c++11 -Iapi -flto -fwasm-exceptions $(WASM_OPTIMIZATION_LEVEL) -sSTRICT=1
EXXLINKFLAGS=-flto -fwasm-exceptions $(WASM_OPTIMIZATION_LEVEL) --emit-tsd=$(TARGET_TSD) -sSTRICT=1
